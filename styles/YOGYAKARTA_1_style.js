...
var style_YOGYAKARTA_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Jumlah Tenaga Kesehatan Menurut Kecamatan di Kota Yogyakarta, 2025 — Sheet1_Total Tenaga Kesehatan");
    ...
    if (value >= 22.000000 && value <= 26.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 26.000000 && value <= 34.600000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.600000 && value <= 43.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 43.400000 && value <= 53.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 53.400000 && value <= 66.000000) {
            style = [ new ol.style.Style({
