...
map.getView().fit([12281775.422376, -875772.593090, 12291677.723087, -867088.878780], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA JUMLAH TENAGA KERJA KESEHATAN YOGYAKARTA</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_YOGYAKARTA_1,
    colName: 'Jumlah Tenaga Kesehatan Menurut Kecamatan di Kota Yogyakarta, 2025 — Sheet1_Tenaga Kesehatan - Perawat',
    zoom: 10,
    collapsed: true,
    map: map,
    maxResults: 10,
